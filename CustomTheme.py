...
class CustomTheme( Theme ):
    ...
    def __init__( 
        ...
        #scale
        self.characterCreateHelpScale = 0.002
        self.characterCreateScale = .002
        self.controlActivateScale = .002
        self.controlDescriptionScale = .002
        self.loadingFScale = 0.002
        self.lobbySelectScale = .002
        self.lobbyTitleScale = 0.0025
        self.main_menu_scaleVar = 1.0
        self.menuTipTextScale = 0.003
        self.oBarHScale = 0.69999999999999996
        self.settingsmenuScale = 0.004
